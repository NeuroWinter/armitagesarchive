...
config :armitage, ArmitageWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: ArmitageWeb.ErrorHTML, json: ArmitageWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Armitage.PubSub,
  live_view: [signing_salt: "jBFUFLx6"]
...
config :armitage, Armitage.Mailer, adapter: Swoosh.Adapters.Local
